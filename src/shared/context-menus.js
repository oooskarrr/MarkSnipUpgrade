...
async function createMenus() {
  ...
  if (options.contextMenus) {
    ...
    browser.contextMenus.create({
      id: "download-markdown-selection-no-links",
      title: "Download Selection As Markdown (No Links/Images)",
      contexts: ["selection"]
    }, () => { });
    browser.contextMenus.create({
    ...
    browser.contextMenus.create({
      id: "download-markdown-all-no-links",
      title: "Download Tab As Markdown (No Links/Images)",
      contexts: ["all"]
    }, () => { });
    ...
    browser.contextMenus.create({
      id: "copy-markdown-selection-no-links",
      title: "Copy Selection As Markdown (No Links/Images)",
      contexts: ["selection"]
    }, () => { });
    browser.contextMenus.create({
    ...
    browser.contextMenus.create({
      id: "copy-markdown-all-no-links",
      title: "Copy Tab As Markdown (No Links/Images)",
      contexts: ["all"]
    }, () => { });
    browser.contextMenus.create({
